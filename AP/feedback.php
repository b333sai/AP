...
{
 $s=mysql_query("SELECT * from feedback WHERE name='$_POST[g_name]' and email='$_POST[e_mail]' and comment='$_POST[comments]' ");
 ...
 mysql_query("INSERT INTO `feedback` SET sno='$number', name='$_POST[g_name]', email='$_POST[e_mail]', comment='$_POST[comments]', date_posted='$date_posted' ");
...
echo '<tr><td style=" color: #0072a6;"  ><label for=email >Email Id:</label></td><td class=right ><input type=email id=email maxlength=100 size=40  name=e_mail placeholder="Your email id..." required/></td></tr>';
